...
function checkDEV() {
  __DEV__ ? invariant("boolean" === typeof DEV_default, DEV_default) : invariant("boolean" === typeof DEV_default, 38);
}
...
var init_responseIterator2 = __esm({
  "node_modules/@apollo/client/link/http/responseIterator.js"() {
...
var defaultMakeData, _a2, forEach, slice, Trie;
...
var init_context_esm = __esm({
  "node_modules/@wry/context/lib/context.esm.js"() {
    ...
    host = maybe3(function() {
      return globalThis;
    }) || maybe3(function() {
      return global;
    }) || /* @__PURE__ */ Object.create(null);
    globalHost = host;
    Slot = globalHost[globalKey] || Array[globalKey] || function(Slot2) {
      try {
...
var Cache, parentEntrySlot, _a3, hasOwnProperty4, toArray, emptySetPool, POOL_TARGET_SIZE, Entry, EntryMethods, defaultMakeCacheKey, caches;
var init_bundle_esm = __esm({
  "node_modules/optimism/lib/bundle.esm.js"() {
    ...
    toArray = (_a3 = Array.from, _a3 === void 0 ? function(collection) {
      var array = [];
...
var init_common = __esm({
  "node_modules/@apollo/client/cache/core/types/common.js"() {
    init_tslib_es6();
    MissingFieldError = function(_super) {
...
var hasOwn, isArray, defaultConfig, TypeOrFieldNameRegExp;
...
var _a4, toString2, hasOwnProperty5, fnToStr, previousComparisons, nativeCodeSuffix;
var init_equality_esm = __esm({
  "node_modules/@wry/equality/lib/equality.esm.js"() {
    _a4 = Object.prototype;
    toString2 = _a4.toString;
    hasOwnProperty5 = _a4.hasOwnProperty;
...
var arrayLikeForEach, FragmentRegistry;
var init_fragmentRegistry = __esm({
  "node_modules/@apollo/client/cache/inmemory/fragmentRegistry.js"() {
    ...
    init_bundle_esm();
    init_utilities2();
    arrayLikeForEach = Array.prototype.forEach;
    FragmentRegistry = function() {
...
var assign, hasOwnProperty6, ObservableQuery;
      ...
      QueryInfo2.prototype.markResult = function(result2, document, options, cacheWriteBehavior) {
        ...
        if ("incremental" in result2 && isNonEmptyArray(result2.incremental)) {
          ...
          result2.incremental.forEach(function(_a5) {
            var data = _a5.data, path = _a5.path, errors = _a5.errors;
            for (var i = path.length - 1; i >= 0; --i) {
              var key = path[i];
...
var hasOwnProperty7, QueryManager;
            ...
            updateCache: function(cache2) {
              ...
              if (update) {
                if (!skipCache) {
                  ...
                  if (diff.complete && !isExecutionPatchIncrementalResult(result2)) {
...
//# sourceMappingURL=chunk-B66ZYUNF.js.map
